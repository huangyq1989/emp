    ...
    <body>
        <div style="overflow:auto;">
            <div style="border:1px solid #808080;margin-bottom:-1px;text-align:center;background-color: #428bca;color: #0E2D5F;">
                <label style="font-size: 23px;color: white" id="title">${cultivateName}-培训学员导入</label>
            </div>

            <!--导入列表-->
            <div style="width:100%;height:690px;float: left;border:1px solid #808080;" id="two_div">
                <div style="text-align:left;margin-top: 2%;margin-left: 3%">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="button" value="导入并预览" onclick="importAndCheck()" style="border-radius:9px;background-color:snow;color: #333333;width:90px;height:30px"/>
                </div>
                <div style="text-align: center; padding:15px;;color: #9EA7B4">
                    <font color="red" id="resultMessage"></font>
                </div>
                <div style="border:1px solid #808080;margin-left: 1%;margin-right: 1%;">
                    ...
                    <div style="text-align: center;padding: 20px 0px 30px 0px;">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="button" onclick="closeWin();" value="取    消" style="border-radius:9px;background-color:#0092DC;color: snow;width:100px;height:30px"/>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function importAndCheck(){
        ...
        if (filesList.length == 0) {//如果取消上传，则改文件的长度为0
            ...
            if (filesList[0].size > 5000000) {
                ...
                $.ajax({
                    url : "${pageContext.request.contextPath}/fileUpload/UploadServlet?type=cultivate&cultivateId=${cultivateId}",
                    type: 'POST',
                    data: formData,
                    async: true,
                    cache: false,
    ...
    function saveImportData(){
        ...
        $.ajax({
            type: "post",
            url: "${pageContext.request.contextPath}/cultivate/saveImportData.do?cultivateId=${cultivateId}",
            data: {"sendData":param},
            traditional:true,
            async:true,
            dataType:"json",
