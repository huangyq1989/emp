    ...
    <body>
        <div style="background: #fafafa; color:#080808">
            <div style="border:1px solid #808080;margin-bottom:-1px;text-align:center;background-color: #428bca;color: #0E2D5F;">
                <label style="font-size: 23px;color: white">证书查询</label>
            </div>
    ...
    $(function(){
        ...
        $("#table").datagrid({
            ...
            columns: [[
                ...
                {field:'certificateNo',title:'证书编号',width:150, halign:"center", align:"center",
                ...
                {field:'certificateTime',title:'发证时间',width:150, halign:"center", align:"center",
