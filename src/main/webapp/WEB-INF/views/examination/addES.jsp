...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#table").datagrid({
            ...
            method:'post',
            url:'${pageContext.request.contextPath}/examination/getESList.do?examinationId=${examinationId}&type=${type}',
            border:true,
            nowrap:false,//允许换行
    ...
    document.getElementById("add").addEventListener("click",function(){
        ...
        function(isConfirm){
            if (isConfirm) {
                ...
                $.ajax({
                    type: "post",
                    url: "${pageContext.request.contextPath}/examination/addES.do?examinationId=${examinationId}",
                    data: {"arr":arr},
                    traditional:true,
                    async:false,
                    dataType:"json",
